...
# ex) 아침마다 보고서를 만들려면 15줄의 코드를 작성하고 실행
...
#   + important 문을 통해서 라이브러리 모듈을 제공
#   ex) important pandas as pd
...
# 3. 인자(argument of parameter) 정의: 함수 입력 값
# 4. return: 함수 종료 의미
# 5. return 반환값 : 함수 종료 + 호출문으로 반환값 전달(tuple)
# 6. return 생략가능 -> 들여쓰기 종료되면 함수 종료
# 7. parameter와 return은 사용하지 않을 수도 있음
#    (입력과 반환이 없는 함수도 존재)
#   +