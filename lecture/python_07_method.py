...
#       + import문을 통해서 라이브러리 모듈을 ㅔㅈ공
#       ex) import pandas as pd
#               df_data = pd.read.excel("path...")

#   3. 사용자 정의 함수
#       1. 개발자가 직접 만들어서 사용하는 함수
...
#   6. return 생략 가능 -> 들여쓰기 종료되면 함수 종료
...
# Default Parameter
# - 만약에 함수 호출시 입력해야하는 parameter가 empty인 경우
...
# 2. global 키워드를 사용하는 방법(권장 X, 사용 X)
a = 1
print(a)
def var_test():
    global a
